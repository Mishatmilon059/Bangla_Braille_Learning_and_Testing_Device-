...
// The original browser-based practice/data-collection instrument (mode,
// attempts-per-session, character set, CSV export, sync, per-character
// mastery tables). Moved here from "শেখা" so a student opening that tab
// sees only the live hardware teaching session, not this researcher tool.
      ...
      <div className="wrap">
        <header>
          <Link href="/" style={{ display: "inline-flex", alignItems: "center", textDecoration: "none" }}>
            <h1>বাংলা ব্রেইল — ডেটা সংগ্রহ</h1>
          </Link>
